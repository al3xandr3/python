...
for f in read_files:
	print f
	run = "jupyter nbconvert --to=html --ExecutePreprocessor.enabled=True --ExecutePreprocessor.timeout=360 {0} --stdout | python {1}ipynb_clean_html_output.py > {0}.html".format(f, os.path.expanduser('~/DropBox/my/projects/python/'))
	os.system(run)
